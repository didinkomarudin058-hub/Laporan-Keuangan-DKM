...
export const initialLandTenants: LandTenant[] = [
  {
    ...
    tipePeriode: "bulanan",
    jatuhTempoTanggal: 5,
    tanggalMulaiSewa: "2025-01-01",
    posDanaTujuan: "Kas Operasional",
    totalTerbayar: 12150000,
    terakhirBayar: "2026-08-01",
    riwayatPembayaran: [
      {
        id: "PAY-202608-01",
        tenantId: "TENANT-01",
        tenantNama: "Bpk. H. Suparno",
        namaLahan: "Kavling Tanah Wakaf Barat Blok A-01",
        tanggal: "2026-08-01",
        periode: "Bulan Agustus 2026",
        bulanTahunKey: "2026-08",
        tahunKey: 2026,
        nominal: 1350000,
        nominalAsli: 1500000,
        diskonPersen: 10,
        metodePembayaran: "Transfer Bank",
        posDanaTujuan: "Kas Operasional",
        keterangan: "Penerimaan Sewa Lahan Wakaf Bulan Agustus 2026",
        petugas: "H. Mohammad Ridwan",
        noKwitansi: "KW-SEWA-202608-001",
      ...
      },
      {
        ...
        metodePembayaran: "Transfer Bank",
        posDanaTujuan: "Kas Operasional",
        keterangan: "Penerimaan Sewa Lahan Wakaf Bulan Juli 2026",
        petugas: "H. Mohammad Ridwan",
        noKwitansi: "KW-SEWA-202607-001",
        statusBayar: "lunas",
        sisaKurangBayar: 0,
      }
    ],
  ...
  },
  {
    id: "TENANT-03",
    unitId: "UNIT-00",
    namaPenyewa: "Bpk. Hendra Gunawan",
    nomorTelepon: "0813-9876-5432",
    nomorKTP: "3275081907850004",
    alamatPenyewa: "Perum Graha Indah Blok C-05",
    kategori: "Kavling Tanah Wakaf",
    namaLahan: "Petak Lahan Depan Masjid Blok D-01",
    lokasiLahan: "Halaman Parkir Luar Selatan",
    luasLahan: "50 m² (5 x 10 m)",
    peruntukanUsaha: "Kios Barbershop & Pangkas Rambut Modern",
    tarifSewa: 1000000,
    diskonPersen: 0,
    keteranganDiskon: "",
    tarifSetelahDiskon: 1000000,
    tipePeriode: "bulanan",
    jatuhTempoTanggal: 5,
    tanggalMulaiSewa: "2026-01-01",
    posDanaTujuan: "Kas Operasional",
    totalTerbayar: 5000000,
    terakhirBayar: "2026-08-05",
    riwayatPembayaran: [
      {
        id: "PAY-202608-03",
        tenantId: "TENANT-03",
        tenantNama: "Bpk. Hendra Gunawan",
        namaLahan: "Petak Lahan Depan Masjid Blok D-01",
        tanggal: "2026-08-05",
        periode: "Bulan Agustus 2026",
        bulanTahunKey: "2026-08",
        ...
        posDanaTujuan: "Kas Operasional",
        keterangan: "Pembayaran Cicilan Ke-1 Sewa Bulan Agustus 2026 (Sisa Rp 500.000)",
        petugas: "H. Mohammad Ridwan",
        noKwitansi: "KW-SEWA-202608-003",
        statusBayar: "cicilan",
        sisaKurangBayar: 500000,
      }
    ],
    catatan: "Bulan ini baru membayar cicilan pertama Rp 500.000, sisa Rp 500.000 dijanjikan pertengahan bulan.",
  },
  {
    id: "TENANT-04",
    unitId: "UNIT-00",
    namaPenyewa: "Ibu Ratna Dewi (Laundry Barokah)",
    nomorTelepon: "0878-1122-3399",
    nomorKTP: "3275084406900005",
    alamatPenyewa: "Kp. Serang RT 02/01",
    kategori: "Stand UMKM & Toko",
    namaLahan: "Kios Sentra Usaha Masjid Blok C-02",
    lokasiLahan: "Sayap Kiri Gerbang Utama",
    luasLahan: "36 m² (6 x 6 m)",
    peruntukanUsaha: "Outlet Jasa Laundry Kiloan & Dry Cleaning",
    tarifSewa: 1100000,
    diskonPersen: 0,
    keteranganDiskon: "",
    tarifSetelahDiskon: 1100000,
    tipePeriode: "bulanan",
    jatuhTempoTanggal: 5,
    tanggalMulaiSewa: "2026-02-01",
    posDanaTujuan: "Kas Operasional",
    totalTerbayar: 5500000,
    terakhirBayar: "2026-07-05",
    riwayatPembayaran: [
      {
        id: "PAY-202607-04",
        tenantId: "TENANT-04",
        tenantNama: "Ibu Ratna Dewi (Laundry Barokah)",
        namaLahan: "Kios Sentra Usaha Masjid Blok C-02",
        tanggal: "2026-07-05",
        periode: "Bulan Juli 2026",
        bulanTahunKey: "2026-07",
        ...
        metodePembayaran: "Transfer Bank",
        posDanaTujuan: "Kas Operasional",
        keterangan: "Penerimaan Sewa Lahan Bulan Juli 2026",
        petugas: "H. Mohammad Ridwan",
        noKwitansi: "KW-SEWA-202607-004",
        statusBayar: "lunas",
        sisaKurangBayar: 0,
      }
    ],
    catatan: "Belum melakukan pembayaran untuk Bulan Agustus 2026 (Menunggak setelah jatuh tempo tgl 5).",
  },
  {
    id: "TENANT-05",
    unitId: "UNIT-00",
    ...
    riwayatPembayaran: [
      {
        id: "PAY-202509-05",
        tenantId: "TENANT-05",
        tenantNama: "Bpk. Agus Salim (Bengkel Motor Barokah)",
        namaLahan: "Petak Lahan Wakaf Timur Blok B-01",
        tanggal: "2025-09-01",
        periode: "Tahun 2025 - 2026",
        tahunKey: 2025,
        nominal: 18000000,
        nominalAsli: 18000000,
        diskonPersen: 0,
        metodePembayaran: "Transfer Bank",
        posDanaTujuan: "Kas Pembangunan",
        keterangan: "Pembayaran Sewa Lahan Tahunan Periode Sep 2025 - Agu 2026",
        petugas: "H. Mohammad Ridwan",
        noKwitansi: "KW-SEWA-202509-001",
        statusBayar: "lunas",
        sisaKurangBayar: 0,
      }
    ],
    catatan: "Sewa tahunan, masa sewa akan berakhir pada akhir Agustus 2026 untuk perpanjangan tahun berikutnya.",
  },
];
